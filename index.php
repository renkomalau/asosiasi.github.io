    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <h1 class="mb-5">Buatlah halaman webmu sendiri bersama kami !</h1>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
            ...
            <h3>Native Programming</h3>
            <p class="lead mb-0">Belajar menjadi programmer bersama kami</p>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
            ...
            <h3>Easy Frameworking</h3>
            <p class="lead mb-0">Terdapat aneka macam framework atau template programming yang dapat kamu gunakan</p>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="features-icons-item mx-auto mb-0 mb-lg-3">
            ...
            <h3>Easy to Use</h3>
            <p class="lead mb-0">Mudah dan cepat dipahami</p>
          </div>
        </div>
      </div>
    </div>
